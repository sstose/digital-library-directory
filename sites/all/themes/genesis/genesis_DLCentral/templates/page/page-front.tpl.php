...
<!--/end Gpanel-->
    ...
    <!--//   Two column Gpanel B   //-->
<?php if ($two_col_first_b or $two_col_second_b): ?>
  <div class="two-col-50-b gpanel clear-block">
    <div class="section region col-1 first"><div class="inner">
      <?php if ($two_col_first_b): print $two_col_first_b; endif; ?>
    </div></div>
    <div class="section region col-2 last"><div class="inner">
      <?php if ($two_col_second_b): print $two_col_second_b; endif; ?>
    </div></div>
  </div>
<?php endif; ?>
<!--/end Gpanel-->     
